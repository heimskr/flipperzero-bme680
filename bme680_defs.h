...
/*
 * BME68X sensor settings structure which comprises ODR,
 * over-sampling and filter settings.
 */
struct bme68x_conf {
	// Humidity oversampling. Refer @ref os
	uint8_t os_hum;
	...
	// Filter coefficient. Refer @ref filte
	uint8_t filter;
...
/*
 * BME68X gas heater configuration
 */
...
struct bme68x_dev {
	...
	// Ambient temperature in Degree 
	int8_t ambTemp;

	// Sensor calibration data
	bme68x_calib_data calib;

	// To store interface error
